...
class AffineCoupling(nn.Module):
    ...
    def __init__(self, mask, hidden_dim):
        ...
        self.batch_norm = BatchNorm1d(self.input_dim)
    ...
    def forward(self, x):
        ...
        # Appliquer Batch Normalization après la transformation affine
        y, logdet_bn = self.batch_norm(y, reverse=False)

        return y, logdet + logdet_bn
    ...
    def inverse(self, y):
        ...
        """
        # Inverser Batch Normalization avant la transformation affine inverse
        y, logdet_bn = self.batch_norm(y, reverse=True)
